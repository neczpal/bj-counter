...
public class HandStrategy {
    ...
    public HandStrategy(RuleConfig config) {
        this.config = config;
    }
    ...
    public  Action getNextAction(Hand currentHand, Card dealerCard) {
        ...
        if(soft) {
            ...
            if (handSum >= 16) {
                ...
                if (config.surrenderOptions >= 1 && currentHand.isStartingHand() && dealerCardVal >= 9 && dealerCardVal <= 10){
                    return Action.SURRENDER;
                } else {
                    return Action.HIT;
                }
            ...
            if (handSum >= 15) {
                ...
                if (config.surrenderOptions >= 1 && currentHand.isStartingHand() &&  dealerCardVal == 10){
                    return Action.SURRENDER;
                } else {
                    return Action.HIT;
                }
            ...
            if (handSum >= 14) {
                ...
                if (config.surrenderOptions >= 1 && currentHand.isStartingHand() &&  dealerCardVal == 10 && !config.dealerPeeks){
                    return Action.SURRENDER;
                } else {
                    return Action.HIT;
                }
